#ifndef PARCIAL2PRACTICA_H_INCLUDED
#define PARCIAL2PRACTICA_H_INCLUDED
...
public:
   ...
   void setClaustro( int claustrox){ claustro = claustrox;}

   bool operator==(int idClaustro);
    /*
    bool operator==( int idClaustro)
    {

        if(this->claustro == idClaustro) return true;
...
#endif // PARCIAL2PRACTICA_H_INCLUDED
